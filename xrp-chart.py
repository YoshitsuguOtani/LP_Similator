...
def get_historical_xrp_data():
    try:
        ...
        url = f"https://api.coingecko.com/api/v3/coins/ripple/market_chart/range"
        params = {
            "vs_currency": "jpy",  # Change to your preferred currency if needed
...
def plot_multiple_charts(df):
    ...
    ax1.set_title('XRP Price Trend (Line)')
    ax1.set_xlabel('Date')
    ...
    # Adjust layout
    plt.suptitle('XRP Price Analysis (Last 365 Days)', fontsize=16, y=1.02)
    plt.tight_layout()
    plt.show()
